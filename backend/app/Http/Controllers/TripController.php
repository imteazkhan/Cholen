...
use App\Models\Trip; // 👈 Important: Import the Trip model
...
class TripController extends Controller
{
    ...
    {
        // A DRIVER has started taking a passenger to their destianation
        $trip->update([
            'is_started'=>true
        ]);
    ...
    public function location(Request $request, Trip $trip)
    {
        ...
        $trip->update([
            'deriver_location' => $request->driver_location
        ]);
